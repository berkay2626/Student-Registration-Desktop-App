...
namespace studentreg
{
    public partial class Form1 : Form
    {
        ...
        //burda hata var cözmek lazim
        SqlConnection con = new SqlConnection(@"Data Source = LAPTOP-79NNLF2K\SQL2019; Initial Catalog = gcbt; Integrated Security = True");
        SqlCommand cmd;
        SqlDataReader read;
        SqlDataAdapter drr;
        string id;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(Mode == true)
            {
                ...
                MessageBox.Show("Record Addddedddddd");
                cmd.ExecuteNonQuery();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (e.ColumnIndex == dataGridView1.Columns["Delete"].Index && e.RowIndex >= 0)
            {
                ...
                cmd.Parameters.AddWithValue("@id ", id);
                cmd.ExecuteNonQuery();
                MessageBox.Show("Record Deleteeed");
                con.Close();
            }
